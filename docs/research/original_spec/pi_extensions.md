> **Source:** https://github.com/earendil-works/pi-mono (local install: /home/lhankor/.local/share/pi-node/.../docs/extensions.md)
...
```typescript
const { output, exitCode } = await pi.exec("git", ["status"]);
```
